        ...
        main1Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (totHeld.getText().toString().matches("") ||
                    ...
                    editor.putInt("Minimum_Percentge", Integer.parseInt(minPercentage.getText().toString()));
                    editor.putInt("Total_Held", Integer.parseInt(totHeld.getText().toString()));
                    editor.putInt("Total_Present", Integer.parseInt(totPresent.getText().toString()));
                    editor.commit();
